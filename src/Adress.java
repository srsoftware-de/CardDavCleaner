...
public class Adress implements DocumentListener, ChangeListener,Comparable<Adress> {
	...
	public VerticalPanel editForm() {
		...
		form.add(streetField=new InputField("Staße/Hausnummer",streetAdress));
		streetField.addChangeListener(this);
		form.add(extendedField=new InputField("erweiterte Adresse",extendedAdress));
		extendedField.addChangeListener(this);
		form.add(zipField=new InputField("Postleitzahl",zip));
		zipField.addChangeListener(this);
		form.add(cityField=new InputField("Ort",city));
		cityField.addChangeListener(this);
		form.add(regionField=new InputField("Region",region));
		regionField.addChangeListener(this);
		form.add(countryField=new InputField("Land",country));
		countryField.addChangeListener(this);
		form.add(postBoxField=new InputField("Postfach",postOfficeBox));
