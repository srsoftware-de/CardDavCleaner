...
public class TranslationDE extends Translation{
	TreeMap<String, String> getTranslations(){
		...
		trans.put("Given name: #", "Vorname: #");
		trans.put("# is not a directory!", "# ist kein Verzeichnis!");		
		trans.put("# is used by the following contacts:", "# wird von den folgenden Kontakten verwendet:");
		...
		trans.put("Merge contacts?", "Kontakte zusammenführen?");
		trans.put("marked for removal", "zum Löschen vorgemerkt");
		...
		trans.put("Reading list of contacts...","Lese Kontaktliste...");
		...
		trans.put("Searching for similar contacts...", "Suche nach ähnlichen Kontakten...");
		...
		trans.put("<html>Scanning, merging and cleaning was <i>demonstrated</i>! To actually perform this tasks, purchase the full version or get the code from github and compile it yourself. Goodbye!", "<html>Analysieren, Zusammenführen und Bereinigen der Kontakte wurde <i>demonstriert</i>! Um diese Aktionen tatsächlich auszuführen, kaufen Sie bitte die Vollversion oder kompilieren Sie den Code von github. Auf Wiedersehen!");
